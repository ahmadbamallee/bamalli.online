...
<body>
  ...
  <section class="section">
    <div class="section__container">
      <div class="content">
        ...
        <h1 class="title">
          I'm <span>Ahmad<br />a</span> Web Developer and <br> Programmer.
        </h1>
        <p class="description">
        </p>
        <div class="action__btns">
          <a href="skills.html">
            <button class="Contact">Skills</button>
          </a>
          <a href="resume.html">
  ...
  <section class="message" style="background-image: url(assets/background/myphoto.JPG);">
